...
public class C02_DataProviderKullanimi extends TestBaseRapor {
    ...
    public void cokluAramaTesti(){
        ...
        for (int i = 0; i < aranacakUrunler.length ; i++) {
            ...
            // asıl data provider kullanimi asağıdaki gibi olmalıdır.
            // asagıdaki kodu çalıştırın üsteki çalılışmaz hata verir altakini run ettigimizde
            // çalıiıp bize var olan ürün ve var olmayan ürün sonucunu gösterir
        }
    }
